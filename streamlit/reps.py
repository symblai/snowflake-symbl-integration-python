...
# with st.container():
#     fig_call_score_by_rep = alt.Chart(sales_rep_df).mark_bar().encode(
#         x=alt.X('REP_NAME', title='Sales Rep'),
#         y=alt.Y('AVG_CALL_SCORE', title='Call Score'),
#     ).properties(
#         title="Call Score by Sales Reps"
#     )
# st.altair_chart(fig_call_score_by_rep, use_container_width=True)
